...
pub struct ValueBatchByepisodeguid200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::Status>,
    #[serde(rename = "query", skip_serializing_if = "Option::is_none")]
    pub query: Option<Box<models::QueryGuids>>,
    /// List of value blocks
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Vec<models::ValueByepisodeguidBatch>>,
    /// Description of the response
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    /// Indicates if data was found for all `podcastguid` and `episodeguid` values.
    #[serde(rename = "allFound", skip_serializing_if = "Option::is_none")]
    pub all_found: Option<bool>,
    /// Number of value data returned.
    #[serde(rename = "found", skip_serializing_if = "Option::is_none")]
    pub found: Option<i32>,
}

impl ValueBatchByepisodeguid200Response {
    pub fn new() -> ValueBatchByepisodeguid200Response {
