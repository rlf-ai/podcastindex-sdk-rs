...
pub struct EpisodesRandom200Response {
    ...
    pub episodes: Option<Vec<models::ItemPodcastRandom>>,
...
impl EpisodesRandom200Response {
    pub fn new() -> EpisodesRandom200Response {
