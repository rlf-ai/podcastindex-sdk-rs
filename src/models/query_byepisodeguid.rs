...
/// QueryByepisodeguid : Object containing the input query data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct QueryByepisodeguid {
    /// The value of the `podcastguid` argument passed to the request.
    #[serde(rename = "podcastguid", skip_serializing_if = "Option::is_none")]
    pub podcastguid: Option<String>,
    /// The value of the `episodeguid` argument passed to the request.
    #[serde(rename = "episodeguid", skip_serializing_if = "Option::is_none")]
    pub episodeguid: Option<String>,
}

impl QueryByepisodeguid {
    /// Object containing the input query data
    pub fn new() -> QueryByepisodeguid {
        QueryByepisodeguid {
            podcastguid: None,
            episodeguid: None,
        }
