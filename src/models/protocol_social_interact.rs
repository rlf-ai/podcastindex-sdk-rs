...
/// ProtocolSocialInteract : The protocol in use for interacting with the comment root post.    For the most up-to-date list of options, see https://github.com/Podcastindex-org/podcast-namespace/blob/main/socialprotocols.txt
/// The protocol in use for interacting with the comment root post.    For the most up-to-date list of options, see https://github.com/Podcastindex-org/podcast-namespace/blob/main/socialprotocols.txt
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ProtocolSocialInteract {
...
impl std::fmt::Display for ProtocolSocialInteract {
...
impl Default for ProtocolSocialInteract {
    fn default() -> ProtocolSocialInteract {
        Self::Disabled
    }
}
