...
/// Value : Information for supporting the podcast via one of the \"Value for Value\" methods. May not be reported.   Examples:   - `lightning` value type: https://api.podcastindex.org/api/1.0/podcasts/byfeedid?id=169991&pretty   - `webmonetization` value type: https://api.podcastindex.org/api/1.0/podcasts/byfeedid?id=779873&pretty
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct Value {
    #[serde(rename = "model", skip_serializing_if = "Option::is_none")]
    pub model: Option<Box<models::ModelV4v>>,
    ...
    pub destinations: Option<Vec<models::DestinationV4v>>,
}

impl Value {
    /// Information for supporting the podcast via one of the \"Value for Value\" methods. May not be reported.   Examples:   - `lightning` value type: https://api.podcastindex.org/api/1.0/podcasts/byfeedid?id=169991&pretty   - `webmonetization` value type: https://api.podcastindex.org/api/1.0/podcasts/byfeedid?id=779873&pretty
    pub fn new() -> Value {
        Value {
            model: None,
            destinations: None,
