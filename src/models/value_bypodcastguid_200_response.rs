...
pub struct ValueBypodcastguid200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::Status>,
    #[serde(rename = "query", skip_serializing_if = "Option::is_none")]
    pub query: Option<Box<models::QueryGuidId>>,
    #[serde(
        rename = "value",
        default,
...
impl ValueBypodcastguid200Response {
    pub fn new() -> ValueBypodcastguid200Response {
