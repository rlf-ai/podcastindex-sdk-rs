...
pub struct PodcastsBytag200Response {
    ...
    pub feeds: Option<Vec<models::FeedBytag>>,
    ...
    /// Feed ID to pass to next `start_at` to get next batch of feeds   Only returned when `start_at` passed to request
    #[serde(rename = "nextStartAt", skip_serializing_if = "Option::is_none")]
    pub next_start_at: Option<i32>,
    /// Description of the response
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl PodcastsBytag200Response {
    pub fn new() -> PodcastsBytag200Response {
