...
pub struct RecentData200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::Status>,
    /// Number of items in the `feeds` returned in request
    #[serde(rename = "feedCount", skip_serializing_if = "Option::is_none")]
    ...
    pub since: Option<Option<i32>>,
    /// Description of the response
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    /// Value to pass as `since` parameter to get next batch of data
    #[serde(rename = "nextSince", skip_serializing_if = "Option::is_none")]
    pub next_since: Option<i32>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::Data>>,
}

impl RecentData200Response {
    pub fn new() -> RecentData200Response {
