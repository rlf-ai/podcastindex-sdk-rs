...
pub struct RecentNewvaluefeeds200Response {
    ...
    pub feeds: Option<Vec<models::FeedsRecentValueInner>>,
...
impl RecentNewvaluefeeds200Response {
    pub fn new() -> RecentNewvaluefeeds200Response {
        RecentNewvaluefeeds200Response {
            status: None,
            feeds: None,
            count: None,
            max: None,
