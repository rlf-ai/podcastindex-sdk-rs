...
#[serde(untagged)]
pub enum EpisodesByfeedid200ResponseQuery {
    /// Single ID passed to request
    QueryPodcastIdSingle(String),
    /// IDs passed to request
    QueryPodcastIdMultiple(Vec<String>),
}

impl Default for EpisodesByfeedid200ResponseQuery {
    fn default() -> Self {
        Self::QueryPodcastIdSingle(Default::default())
    }
}
