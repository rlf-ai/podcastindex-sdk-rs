...
pub struct PodcastsTrending200Response {
    ...
    pub feeds: Option<Vec<models::FeedTrending>>,
...
impl PodcastsTrending200Response {
    pub fn new() -> PodcastsTrending200Response {
        PodcastsTrending200Response {
            status: None,
            feeds: None,
            count: None,
            max: None,
