...
pub struct LiveitemPodcast {
    ...
    pub status: Option<models::StatusLive>,
    /// Link TODO
    ...
    #[serde(
        rename = "transcriptUrl",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub transcript_url: Option<Option<String>>,
}

impl LiveitemPodcast {
    pub fn new() -> LiveitemPodcast {
        LiveitemPodcast {
            id: None,
            title: None,
            link: None,
