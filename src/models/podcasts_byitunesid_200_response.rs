...
pub struct PodcastsByitunesid200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::Status>,
    #[serde(rename = "query", skip_serializing_if = "Option::is_none")]
    pub query: Option<Box<models::QueryId>>,
    #[serde(rename = "feed", skip_serializing_if = "Option::is_none")]
    pub feed: Option<Box<models::FeedItunes>>,
    /// Description of the response
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl PodcastsByitunesid200Response {
    pub fn new() -> PodcastsByitunesid200Response {
        PodcastsByitunesid200Response {
            status: None,
            query: None,
            feed: None,
            description: None,
