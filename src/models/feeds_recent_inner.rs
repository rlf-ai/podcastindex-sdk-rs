...
pub struct FeedsRecentInner {
    ...
    #[serde(
        rename = "oldestItemPublishTime",
        skip_serializing_if = "Option::is_none"
    )]
    pub oldest_item_publish_time: Option<i32>,
...
impl FeedsRecentInner {
    pub fn new() -> FeedsRecentInner {
        FeedsRecentInner {
            id: None,
            url: None,
            title: None,
            newest_item_publish_time: None,
            oldest_item_publish_time: None,
            itunes_id: None,
            language: None,
            categories: None,
        }
