...
pub struct EpisodesByfeedid200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::Status>,
    /// List of live episodes for feed
    #[serde(rename = "liveItems", skip_serializing_if = "Option::is_none")]
    pub live_items: Option<Vec<models::LiveitemPodcast>>,
    /// List of episodes matching request
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<models::ItemPodcast>>,
    /// Number of items returned in request
    #[serde(rename = "count", skip_serializing_if = "Option::is_none")]
    pub count: Option<i32>,
    #[serde(rename = "query", skip_serializing_if = "Option::is_none")]
    pub query: Option<Box<models::EpisodesByfeedid200ResponseQuery>>,
    /// Description of the response
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl EpisodesByfeedid200Response {
    pub fn new() -> EpisodesByfeedid200Response {
        EpisodesByfeedid200Response {
            status: None,
            live_items: None,
            items: None,
            count: None,
