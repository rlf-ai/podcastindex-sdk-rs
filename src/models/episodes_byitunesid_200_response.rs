...
impl EpisodesByitunesid200Response {
    pub fn new() -> EpisodesByitunesid200Response {
        EpisodesByitunesid200Response {
            status: None,
            items: None,
            count: None,
            query: None,
