...
pub struct PodcastsDead200Response {
    ...
    pub feeds: Option<Vec<models::FeedDead>>,
...
impl PodcastsDead200Response {
    pub fn new() -> PodcastsDead200Response {
        PodcastsDead200Response {
            status: None,
            feeds: None,
            count: None,
            description: None,
