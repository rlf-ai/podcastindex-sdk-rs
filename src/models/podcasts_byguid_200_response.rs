...
pub struct PodcastsByguid200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::Status>,
    #[serde(rename = "query", skip_serializing_if = "Option::is_none")]
    pub query: Option<Box<models::QueryGuid>>,
...
impl PodcastsByguid200Response {
    pub fn new() -> PodcastsByguid200Response {
        PodcastsByguid200Response {
            status: None,
            query: None,
            feed: None,
            description: None,
