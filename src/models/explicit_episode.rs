...
/// ExplicitEpisode : Is feed or episode marked as explicit    - 0: not marked explicit   - 1: marked explicit
/// Is feed or episode marked as explicit    - 0: not marked explicit   - 1: marked explicit
#[repr(i64)]
#[derive(
    Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize_repr, Deserialize_repr,
)]
pub enum ExplicitEpisode {
    Variant0 = 0,
    Variant1 = 1,
}

impl std::fmt::Display for ExplicitEpisode {
...
impl Default for ExplicitEpisode {
    fn default() -> ExplicitEpisode {
        Self::Variant0
    }
}
