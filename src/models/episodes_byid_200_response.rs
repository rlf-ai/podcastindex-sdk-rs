...
pub struct EpisodesByid200Response {
    ...
    pub episode: Option<Box<models::EpisodeObject>>,
    /// Description of the response
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl EpisodesByid200Response {
    pub fn new() -> EpisodesByid200Response {
        EpisodesByid200Response {
            status: None,
            id: None,
            episode: None,
            description: None,
