...
impl EpisodesLive200Response {
    pub fn new() -> EpisodesLive200Response {
        EpisodesLive200Response {
            status: None,
            items: None,
            count: None,
            max: None,
