...
pub struct RecentNewfeeds200Response {
    ...
    pub feeds: Option<Vec<models::FeedsRecentNewInner>>,
...
impl RecentNewfeeds200Response {
    pub fn new() -> RecentNewfeeds200Response {
        RecentNewfeeds200Response {
            status: None,
            feeds: None,
            count: None,
            max: None,
