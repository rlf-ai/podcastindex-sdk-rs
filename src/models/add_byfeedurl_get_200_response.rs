...
pub struct AddByfeedurlGet200Response {
    ...
    #[serde(rename = "existed", skip_serializing_if = "Option::is_none")]
    pub existed: Option<models::Existed>,
    /// Description of the response
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl AddByfeedurlGet200Response {
    pub fn new() -> AddByfeedurlGet200Response {
        AddByfeedurlGet200Response {
            status: None,
            feed_id: None,
            existed: None,
            description: None,
