...
/// DestinationV4v : Destination for \"Value for Value\" payment.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DestinationV4v {
    ...
    pub r#type: Option<models::TypeDestination>,
    ...
    pub fee: Option<Option<bool>>,
    /// The name of a custom record key to send along with the payment. May not be reported.   See the [podcast namespace spec](https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/1.0.md#value) and [value specification](https://github.com/Podcastindex-org/podcast-namespace/blob/main/value/value.md) for more information.
    #[serde(
        rename = "customKey",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub custom_key: Option<Option<String>>,
    /// A custom value to pass along with the payment. This is considered the value that belongs to the customKey. May not be reported.   See the [podcast namespace spec](https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/1.0.md#value) and [value specification](https://github.com/Podcastindex-org/podcast-namespace/blob/main/value/value.md) for more information.
    #[serde(
        rename = "customValue",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub custom_value: Option<Option<String>>,
}

impl DestinationV4v {
    /// Destination for \"Value for Value\" payment.
    pub fn new() -> DestinationV4v {
        DestinationV4v {
            name: None,
            address: None,
            r#type: None,
