...
pub struct ValueByepisodeguid200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::Status>,
    #[serde(rename = "query", skip_serializing_if = "Option::is_none")]
    pub query: Option<Box<models::QueryByepisodeguid>>,
    #[serde(
        rename = "value",
        default,
    ...
    pub value: Option<Option<Box<models::ValueByepisodeguid>>>,
    /// Description of the response
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl ValueByepisodeguid200Response {
    pub fn new() -> ValueByepisodeguid200Response {
        ValueByepisodeguid200Response {
            status: None,
            query: None,
            value: None,
            description: None,
