...
/// QueryGuids : Object containing the input query data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct QueryGuids {
    /// The `podcastguid` and `episodeguid` values passed to the request.
    #[serde(rename = "guids", skip_serializing_if = "Option::is_none")]
    pub guids: Option<std::collections::HashMap<String, Vec<String>>>,
}

impl QueryGuids {
    /// Object containing the input query data
    pub fn new() -> QueryGuids {
        QueryGuids { guids: None }
    }
}
