...
pub struct RecentSoundbites200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::Status>,
    /// List of soundbites matching request
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<models::ItemsSoundbitesInner>>,
...
impl RecentSoundbites200Response {
    pub fn new() -> RecentSoundbites200Response {
        RecentSoundbites200Response {
            status: None,
            items: None,
            count: None,
            description: None,
