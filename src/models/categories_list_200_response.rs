...
pub struct CategoriesList200Response {
    ...
    pub feeds: Option<Option<Vec<models::FeedCategories>>>,
...
impl CategoriesList200Response {
    pub fn new() -> CategoriesList200Response {
