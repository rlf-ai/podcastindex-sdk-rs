...
/// ValueByepisodeguidBatch : Information for supporting the podcast via one of the \"Value for Value\" methods.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ValueByepisodeguidBatch {
