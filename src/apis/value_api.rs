...
/// struct for typed errors of method [`value_slash_batch_slash_byepisodeguid`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValueSlashBatchSlashByepisodeguidError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`value_slash_byepisodeguid`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValueSlashByepisodeguidError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`value_slash_byfeedid`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValueSlashByfeedidError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`value_slash_byfeedurl`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValueSlashByfeedurlError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`value_slash_bypodcastguid`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValueSlashBypodcastguidError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}
...
pub async fn value_slash_batch_slash_byepisodeguid(
    configuration: &configuration::Configuration,
    request_body: std::collections::HashMap<String, Vec<String>>,
    pretty: Option<bool>,
) -> Result<models::ValueBatchByepisodeguid200Response, Error<ValueSlashBatchSlashByepisodeguidError>>
{
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ValueSlashBatchSlashByepisodeguidError> =
...
pub async fn value_slash_byepisodeguid(
    configuration: &configuration::Configuration,
    podcastguid: &str,
    episodeguid: &str,
    pretty: Option<bool>,
) -> Result<models::ValueByepisodeguid200Response, Error<ValueSlashByepisodeguidError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/value/byepisodeguid", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    local_var_req_builder =
        local_var_req_builder.query(&[("podcastguid", &podcastguid.to_string())]);
    local_var_req_builder =
        local_var_req_builder.query(&[("episodeguid", &episodeguid.to_string())]);
    if let Some(ref local_var_str) = pretty {
        local_var_req_builder =
            local_var_req_builder.query(&[("pretty", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ValueSlashByepisodeguidError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn value_slash_byfeedid(
    configuration: &configuration::Configuration,
    id: i32,
    pretty: Option<bool>,
) -> Result<models::ValueByfeedid200Response, Error<ValueSlashByfeedidError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/value/byfeedid", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ValueSlashByfeedidError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn value_slash_byfeedurl(
    configuration: &configuration::Configuration,
    url: &str,
    pretty: Option<bool>,
) -> Result<models::ValueByfeedurl200Response, Error<ValueSlashByfeedurlError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/value/byfeedurl", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ValueSlashByfeedurlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn value_slash_bypodcastguid(
    configuration: &configuration::Configuration,
    guid: &str,
    pretty: Option<bool>,
) -> Result<models::ValueBypodcastguid200Response, Error<ValueSlashBypodcastguidError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/value/bypodcastguid", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ValueSlashBypodcastguidError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
