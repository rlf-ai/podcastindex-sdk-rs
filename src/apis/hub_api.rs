...
/// struct for typed errors of method [`hub_slash_pubnotify`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum HubSlashPubnotifyError {
...
pub async fn hub_slash_pubnotify(
    configuration: &configuration::Configuration,
    id: Option<i32>,
    url: Option<&str>,
    pretty: Option<bool>,
) -> Result<models::Search400Response, Error<HubSlashPubnotifyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/hub/pubnotify", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<HubSlashPubnotifyError> =
