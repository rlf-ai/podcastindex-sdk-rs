...
/// struct for typed errors of method [`search_slash_byperson`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchSlashBypersonError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`search_slash_byterm`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchSlashBytermError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`search_slash_bytitle`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchSlashBytitleError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`search_slash_music_slash_byterm`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchSlashMusicSlashBytermError {
    Status400(models::Search400Response),
    Status401(String),
    UnknownValue(serde_json::Value),
}
...
pub async fn search_slash_byperson(
    configuration: &configuration::Configuration,
    q: &str,
    max: Option<i32>,
    fulltext: Option<bool>,
    pretty: Option<bool>,
) -> Result<models::SearchByperson200Response, Error<SearchSlashBypersonError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/search/byperson", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<SearchSlashBypersonError> =
...
pub async fn search_slash_byterm(
    configuration: &configuration::Configuration,
    q: &str,
    val: Option<&str>,
    max: Option<i32>,
    ...
    fulltext: Option<bool>,
    pretty: Option<bool>,
) -> Result<models::SearchByterm200Response, Error<SearchSlashBytermError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/search/byterm", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    local_var_req_builder = local_var_req_builder.query(&[("q", &q.to_string())]);
    if let Some(ref local_var_str) = val {
        local_var_req_builder = local_var_req_builder.query(&[("val", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max {
        local_var_req_builder = local_var_req_builder.query(&[("max", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = aponly {
        local_var_req_builder =
            local_var_req_builder.query(&[("aponly", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = clean {
        local_var_req_builder =
            local_var_req_builder.query(&[("clean", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = similar {
        local_var_req_builder =
            local_var_req_builder.query(&[("similar", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = fulltext {
        local_var_req_builder =
            local_var_req_builder.query(&[("fulltext", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<SearchSlashBytermError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_slash_bytitle(
    configuration: &configuration::Configuration,
    q: &str,
    val: Option<&str>,
    max: Option<i32>,
    ...
    pretty: Option<bool>,
    similar: Option<bool>,
) -> Result<models::SearchByterm200Response, Error<SearchSlashBytitleError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/search/bytitle", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<SearchSlashBytitleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_slash_music_slash_byterm(
    configuration: &configuration::Configuration,
    q: &str,
    val: Option<&str>,
    aponly: Option<bool>,
    ...
    fulltext: Option<bool>,
    pretty: Option<bool>,
) -> Result<models::SearchByterm200Response, Error<SearchSlashMusicSlashBytermError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/search/music/byterm", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<SearchSlashMusicSlashBytermError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
